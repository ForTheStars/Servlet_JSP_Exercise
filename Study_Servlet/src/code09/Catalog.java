...
public class Catalog {
	private static CatalogItem[] items = { new CatalogItem("hall001",
			...
			39.95),
			new CatalogItem("hall002", "<I>Core Web Programming, 2nd Edition</I> " + "by Marty Hall and Larry Brown",
					"One stop shopping for the Web programmer. " + "Topics include \n"
							...
							+ "</UL>",
					49.99),
			new CatalogItem("lewis001", "<I>The Chronicles of Narnia</I> by C.S. Lewis",
					"The classic children's adventure pitting " + "Aslan the Great Lion and his followers\n"
							...
							+ "<I>The Last Battle</I>.",
					19.95),
			new CatalogItem("alexander001", "<I>The Prydain Series</I> by Lloyd Alexander",
					...
					19.95),
			new CatalogItem("rowling001", "<I>The Harry Potter Series</I> by J.K. Rowling",
